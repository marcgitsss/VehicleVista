...
export default function ApproveApplication() {
    ...
    const [checkRowNew, setCheckRowNew] = useState(false);
    ...
    const handleCheckboxRow = (event) => {
        setCheckRow(event.target.checked);
        setSelectedRows([]);
    };

    const handleCheckboxRowNew = (event) => {
        setCheckRowNew(event.target.checked);
        setSelectedRows([]);
    };
                                                ...
                                                >
                                                    {checked && (<TableCell align="center">
                                                        <Checkbox
                                                            ...
                                                            onChange={(event) => handleCheckboxRow(event, row.id)}
                                                        />
                                                    </TableCell>
                                            ...
                                            {rows.map((row) => (
                                                ...
                                                >
                                                    {checked && (<TableCell align="center">
                                                        <Checkbox
                                                            checked={row.isChecked}
                                                            onChange={(event) => handleCheckboxRowNew(event, row.id)}
                                                        />
                                                    </TableCell>
