                                ...
                                <Paper sx={{ width: 'clamp(25rem, 40vw, 100%)', height: 'clamp(20rem, 50vh, 100%)', borderRadius: '5rem 5rem 5rem 5rem', padding: '3rem', backgroundColor: 'rgba(228, 228, 228, 0.5)', }}>
                                    <div>
                                        ...
                                        <Typography component="div" sx={{ marginLeft:  'clamp(2rem, 10%, 20rem)' }}>
                                            ...
                                            <div style={{ display: "flex", alignItems: "center", margin: "-1rem" }}>
                                                <h3 style={{ textAlign: "left" }}>License:</h3>&nbsp;<Button sx={{ textTransform: "none", color: "#8A252C" }}>Click to View Image</Button>
                                            </div>
                                            <div style={{ display: "flex", alignItems: "center", margin: "-1rem" }}>
                                                <h3 style={{ textAlign: "left" }}>OR/CR:</h3>&nbsp;<Button sx={{ textTransform: "none", color: "#8A252C" }}>Click to View Image</Button>
                                            </div>
                                        </Typography>
                                    </div>
