                        ...
                        <div style={{ margin: '1rem 0' }}>
                            ...
                            {open === false && (
                                <TableContainer component={Paper} sx={{position: 'relative', backgroundColor: '#D9D9D9', borderRadius: '0.5rem', height: 'clamp(20rem, 50vh, 30rem)', width: 'clamp(20rem, 70vw, 70rem)' }}>
                                    <Table aria-label="simple table">
                                        <TableHead>
                                            <TableRow>
                                                ...
                                                <TableCell align="center" sx={{ fontWeight: 'bold', paddingLeft: 'clamp(.25rem, 5vw, 3rem)', paddingRight: 'clamp(.25rem, 5vw, 3rem)' }}>Status</TableCell>
                                    ...
                                    <Button sx={{ position: 'absolute', bottom: '1rem', right: '1rem', backgroundColor: '#F4C522', color: 'black', textTransform: 'none', fontWeight: 'bold', '&:hover': { backgroundColor: '#F4C522' } }}>Proceed to Payment</Button>                                </TableContainer>
                            )}
                        </div>
                    </Grid>
                    <Grid item xs={2} > </Grid>
