import { Button, Checkbox, Container, Grid, Paper, TableFooter, Typography, useMediaQuery, CircularProgress } from '@mui/material';
...
export default function ApproveApplication() {
    ...
    console.log('Multiplerow', selectMultiple);
                                                    ...
                                                    <TableRow>
                                                        ...
                                                        <TableCell colSpan={4} align="center" >
                                                            <Button
                                                                ...
                                                                disabled={isLoading || selectedRows === null || selectedRows.length === 0}
